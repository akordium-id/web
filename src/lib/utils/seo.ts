...
export const defaultSEO: SEOProps = {
  ...
  keywords: ["digital", "pembuatan website", "pembuatan aplikasi", "edukasi", "indonesia", "jawa", "web development", "app development", "digital marketing"],
  ogType: "website",
...
export function generateMetaTags(seo: Partial<SEOProps> = {}): Array<{ name?: string; property?: string; content: string }> {
