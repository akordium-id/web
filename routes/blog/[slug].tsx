    ...
    >
      ...
      <main class="min-h-screen bg-gradient-to-b from-base to-gray-100">
        <div class="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
          <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-secondary/20">
            {/* Back to Blog Link */}
            <a
              href="/blog"
              class="inline-flex items-center text-tertiary hover:text-secondary mb-8 group"
            >
              <svg
            ...
            {/* Article Content */}
            <article class="prose prose-lg max-w-none prose-headings:text-primary prose-p:text-primary/80 prose-a:text-tertiary prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl">
              <div
            ...
            {/* Share Section */}
            <div class="mt-12 pt-8 border-t border-secondary/20">
              ...
              <div class="flex space-x-4">
                <a
                  ...
                  class="text-primary/60 hover:text-tertiary"
                >
