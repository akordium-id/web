    ...
    <section class="bg-white py-12 md:py-24 relative overflow-hidden">
      ...
      <div class="container mx-auto px-4 grid md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
        ...
        <div class="relative mt-8 md:mt-0">
          <div class="absolute -top-10 -left-10 w-16 h-16 md:w-20 md:h-20 bg-secondary/20 rounded-full">
          </div>
          <div class="absolute -bottom-5 -right-5 w-24 h-24 md:w-32 md:h-32 bg-secondary/10 rounded-full">
          </div>
          <img
            ...
            width={500}
            height={400}
            class="rounded-lg relative z-10 object-cover w-full h-auto"
          />
          <div class="absolute -bottom-6 -right-6 md:-bottom-8 md:-right-8 bg-white p-3 md:p-4 rounded-full shadow-lg z-20 dark:bg-tertiary">
            <img
