...
export default function Footer() {
  return (
    <footer className="bg-muted text-primary py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div className="col-span-1">
            <h3 className="font-bold mb-4">{name} Lab</h3>
            <p className="text-sm mb-4 text-primary">
              Your Digital Partner for Growth
            </p>
            {/* <p className="text-sm mb-4">PT. Digital Gerojok Berkah</p> */}
            <div className="flex space-x-0 md:space-x-4">
              ...
              <a href="#" className="hover:text-gray-300" title="LinkedIn">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a href="#" className="hover:text-gray-300" title="X">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a href="#" className="hover:text-gray-300" title="TikTok">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#" className="hover:text-gray-300">Web Application</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          <p className="text-sm text-primary">
            © {new Date().getFullYear()} Akordium. All rights reserved.
          </p>
