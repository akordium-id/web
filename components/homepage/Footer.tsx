      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1">
            ...
            <ul class="space-y-2 text-sm">
              ...
              <li>
                <a href="#" class="hover:text-base">Web Application</a>
              </li>
              <li>
                <a href="#" class="hover:text-base">
                  Mobile Application
              ...
              <li>
                <a href="#" class="hover:text-base">UI/UX Design</a>
              </li>
              <li>
                <a href="#" class="hover:text-base">
          ...
          <div class="col-span-1">
            ...
            <ul class="space-y-2 text-sm">
              <li>
                <a href="#" class="hover:text-base">About</a>
              </li>
              <li>
                <a href="#" class="hover:text-base">Portfolio</a>
              </li>
              <li>
                <a href="#" class="hover:text-base">Blog</a>
              </li>
              <li>
                <a href="#" class="hover:text-base">Contact</a>
              </li>
              <li>
                <a
        ...
        <div class="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          ...
          <div class="flex gap-4 mt-4 md:mt-0">
            <a href="#" class="hover:text-base">Privacy Policy</a>
            <a href="#" class="hover:text-base">Terms of Service</a>
            <a href="#" class="hover:text-base">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
